...
def check_play_button(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x, mouse_y):
    """start game while player click Play button"""
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0:
        # if all aliens are wiped out, increase game level
        bullets.empty()
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        # create a fleet of new aliens and place the ship to the bottom middle of the screen
        create_fleet(ai_settings, screen, ship, aliens)
        ship.center_ship()
...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """check if aliens reach the bottom of screen"""
    screen_rect = screen.get_rect()
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            # treat it like a ship is hit
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # check if aliens reach the screen bottom
...
def check_high_score(stats, sb):
    """check if the current socre is higher than the highest score"""
